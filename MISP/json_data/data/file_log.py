...
list1 = list()
for dirpath, dirname, filenames in walk('C:\\Users\\user\\mic-graph4\\Scripts\\security-api-solutions\\Samples\\MISP\\misp_graph'):
    a = filenames
...
for i in range(0,len(a)):
    #print(a[i])
    file = open('C:\\Users\\user\\mic-graph4\\Scripts\\security-api-solutions\\Samples\\MISP\\misp_graph\\'+str(a[i]),'r')
    a1 = json.load(file)
