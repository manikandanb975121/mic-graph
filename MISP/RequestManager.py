...
class RequestManager:
    ...
    def comparison_two(self,response):
        ...
        json.dump(list1, open(f'{COMMON_DIRECTORY_NAME}/{log_file_name}', 'w'), indent=2)
        ...
        for i in range(0,len(list1)):
            ...
            log_file_name = f"{self._get_datetime_now()}.json"
            json.dump(common_events, open(f'{COMMON_EVENTS_DIRECTORY_NAME}/{log_file_name}', 'w'), indent=2)
            ...
            log_file_name = f"{self._get_datetime_now()}.json"
            json.dump(events, open(f'{MISP_DIRECTORY_NAME}/{log_file_name}', 'w'), indent=2)
